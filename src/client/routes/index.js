...
const routes = (
  <Route path="/" getComponent={(nextState, callback) => {
    ...
    <Route path="about-us"      getComponent={(nextState, callback) => {
      if(IsServer) {
    ...
    <Route path="contact-us"    getComponent={(nextState, callback) => {
      if(IsServer) {
    ...
    <Route path="team"          getComponent={(nextState, callback) => {
      if(IsServer) {
    ...
    <Route path="partners"      getComponent={(nextState, callback) => {
      if(IsServer) {
    ...
    <Route path="products"      getComponent={(nextState, callback) => {
      if(IsServer) {
    ...
    <Route path="feedback"      getComponent={(nextState, callback) => {
      if(IsServer) {
    ...
    <Route path="articles/:articleId"      getComponent={(nextState, callback) => {
      if(IsServer) {
    ...
    <Route path="articles/:articleId/edit" getComponent={(nextState, callback) => {
      if(IsServer) {
    ...
    <Route path="courses/:courseId"      getComponent={(nextState, callback) => {
      if(IsServer) {
    ...
    <Route path="courses/:courseId/edit" getComponent={(nextState, callback) => {
      if(IsServer) {
    ...
    <Route path=":username"           getComponent={(nextState, callback) => {
      if(IsServer) {
    ...
    <Route path=":username/classroom" getComponent={(nextState, callback) => {
      if(IsServer) {
